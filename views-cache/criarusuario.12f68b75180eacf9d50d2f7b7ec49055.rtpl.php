                ...
                <div class="card-body d-flex align-items-center">
                  <div class="col-md-7 pt-4 pb-4">
                    ...
                    <form action="/admin/usuario/criar" method="post" class="row g-2 d-flex justify-content-center">
                      ...
                      <div class="col-3 pt-3">
                        <button class="btn w-100" type="submit" style="background-color: #26A234; color: white">Criar</button>
                      </div>
                  ...
                  <div class="col-md-5">
                    <img src="../../res/admin/assets/img/criar_usuario.png" alt="Receita Única" style="max-height: 63vh;">
                  </div> 
                </div>
            </div>
        </div>

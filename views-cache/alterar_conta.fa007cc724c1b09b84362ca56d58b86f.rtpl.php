            ...
            <div class="col-lg-12">
                ...
                <div class="card" style="min-height: 66vh;">
                    <div class="card-body d-flex align-items-center">
                      <div class="col-md-7">
                        <form action="/conta/alterar" method="post" class="row g-4 pt-2 pb-4 d-flex justify-content-center">

                            <div class="col-md-10">
                              <label for="id_conta" class="form-label visually-hidden">ID Conta</label>
                              <input type="text" class="form-control visually-hidden" name="id_conta" id="id_conta" value="<?php echo htmlspecialchars( $conta["id_conta"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                            </div>

                            <div class="col-md-10">
                                <label for="apelido_conta" class="form-label">Nome ou Apelido</label>
                                <input type="text" class="form-control" name="apelido" id="apelido_conta" value="<?php echo htmlspecialchars( $conta["apelido"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
                            </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="number" class="form-control" name="valor" id="valor" value="<?php echo htmlspecialchars( $conta["saldo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"  required>
                            </div>

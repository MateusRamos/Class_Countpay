...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- Inicio Notificações -->
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#notificacoes" data-bs-toggle="collapse" href="#">
          <i class="bx bxs-bell"></i><span>Notificações</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>

        <ul id="notificacoes" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="/notificacoes/criar">
              <i class="bx bxs-chevron-right"></i><span>Criar Notificações</span>
            </a>
          </li>
        </ul>
      ...
      <!-- Inicio Perfil -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="/admin/perfil">
      ...
      <!-- Inicio Contato -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="/admin/contato">
